...
<body>
    ...
    $result = $conn->query($sql);  #on met le resultat dans conn-> query()
    ...
    <section class="events-list">
        ...
        <div class="events-grid">
            ...
            <!-- $events C’est le tableau à parcourir. -->
            <!-- as $event À chaque tour de boucle, une seule entrée du tableau $events est stockée dans $event. -->
