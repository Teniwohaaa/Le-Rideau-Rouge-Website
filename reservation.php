...
<head>
    <meta charset="UTF-8">
    <title>Réservation - <?php echo htmlspecialchars($event['title']) ?></title>
...
<div class="reservation-hero" style="background-image: url('images/<?php echo htmlspecialchars($event['image_path']) ?>');">
    <div class="reservation-hero-content">
        <h2>Réservation: <?php echo htmlspecialchars($event['title']) ?></h2>
        <p><?php echo htmlspecialchars($event['venue']) ?> • <?php echo date('d M Y à H:i', strtotime($event['date_event'])) ?></p>
    </div>
</div>
